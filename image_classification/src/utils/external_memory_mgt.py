...
def update_activation_c_code(c_project_path: str, path_network_c_graph: str, available_AXIRAM: int, cfg = None):
    ...
    _, input_shape = get_model_name_and_its_input_shape(model_path=cfg.general.model_path)
