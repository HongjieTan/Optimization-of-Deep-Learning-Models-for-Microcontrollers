...
from MobileNetV3 import get_mobnetv3
import EmbeddedNetV1
...
def get_model(cfg: DictConfig = None, num_classes: int = None, dropout: float = None,
    ...
    if model_name == "MobileNetV3_Embedded":
        check_attributes(cfg, expected=["name", "input_shape","alpha"],
                         optional=["pretrained_model_path"],
                         section=section)
        model = MobileNetV3_Embedded.get_scratch_model(input_shape=cfg.input_shape,
                        alpha=cfg.alpha,
                        dropout=dropout,
                        num_classes=num_classes)
    ...
    if model_name == "MobileNetV3":
        check_attributes(cfg, expected=["name", "input_shape","alpha"],
                         optional=["pretrained_model_path"],
                         section=section)
        model = get_mobnetv3(input_shape=cfg.input_shape,
                        alpha=cfg.alpha,
                        dropout=dropout,
                        num_classes=num_classes)
            
    if model_name == "EmbeddedNetV1":
        check_attributes(cfg, expected=["name", "input_shape","model_width"],
                         optional=["pretrained_model_path"],
                         section=section)
        model = EmbeddedNetV1.get_scratch_model(input_shape=cfg.input_shape,
                        model_width=cfg.model_width,
                        dropout=dropout,
                        num_classes=num_classes)
            
    if model_name == "EmbeddedNetV2":
        check_attributes(cfg, expected=["name", "input_shape","model_width"],
                         optional=["pretrained_model_path"],
                         section=section)
        model = EmbeddedNetV2.get_scratch_model(input_shape=cfg.input_shape,
                        model_width=cfg.model_width,
                        dropout=dropout,
                        num_classes=num_classes)
    ...
    if model_name == "EfficientNetV2":
        check_attributes(cfg, expected=["name", "input_shape"],
                         optional=["pretrained_model_path"],
                         section=section)
        model = EfficientNetV2.get_scratch_model(input_shape=cfg.input_shape, num_classes=num_classes)
